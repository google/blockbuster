...
TODO: _DEFAULT_BATCH_SIZE is currently dictated by BQ blob size.
This is a big limitation as Adwords API could accept up to 500,000 events in
Reference:
...
from dependencies.hooks import ads_hook
