...
from dependencies.utils import cloud_auth
...
class CampaignManagerHook(output_hook_interface.OutputHookInterface):
  ...
  def send_events(self, blb: blob.Blob) -> blob.Blob:
    ...
    TODO:This is a partial implementation of the send_events method.
    Currently, this method validates the input conversion payload.
    Subsequent checkins will contain the logic for batching & CM API calls.
