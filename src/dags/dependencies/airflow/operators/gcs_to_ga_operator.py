...
from dependencies.airflow.hooks import ga_hook
from dependencies.airflow.hooks import gcs_hook
from dependencies.airflow.operators import data_connector_operator
